...
import avisosRoutes from '../src/avisos/avisos.routes.js';
...
const routes = (app) => {
    ...
    app.get(`${BASE_PATH}/health`, (req, res) => {
        res.status(200).json({
            ...
            service: 'Sistema Parroquial Server'
        });
    });
...
export const initServer = async () => {
    ...
    try {
        ...
        console.error(`Sistema Parroquial - Error al iniciar el servidor: ${err.message}`);
        process.exit(1);
    }
};